...
public final class BotResponses {
    ...
    public static String startMessage() {
        return """
                ...
                А пока что, чтобы отпраздновать ваше присоединение к *"Ледиком"*, активируйте *приветственный купон со скидкой 5%* на любые товары (действителен в течение 30 дней). Это ваш первый шаг к заботе о вашем здоровье с нами.
    ...
    public static String consultationWiki() {
        return """
                ...
                *Как правильно задавать вопросы*
                ...
                1. *Сформулируйте вопрос четко и развернуто:* _Постарайтесь выразить свой вопрос ясно и в полном объеме. Можете использовать несколько предложений. Это поможет боту лучше понять ваш запрос и дать более точный ответ._

                2. *Соблюдайте ограничение в 300 символов:* _Ваш вопрос должен быть коротким и не превышать 300 символов._

                3. *Соблюдайте тему медицины или здоровья:* _Бот специализирован на вопросах по медицине и здоровью, поэтому задавайте вопросы, связанные с этой темой._
    ...
    public static String consultationShortWiki() {
        return "Постарайтесь выразить свой вопрос ясно и в полном объеме. Можете использовать несколько предложений. Это поможет боту лучше понять ваш запрос и дать более точный ответ.";
    }
