    ...
    public static String consultationWiki() {
        return """
                ...
                *Как правильно задавать вопросы*
                ...
                1. *Сформулируйте вопрос четко и развернуто:* Постарайтесь выразить свой вопрос ясно и в полном объеме. Это поможет боту лучше понять ваш запрос и дать более точный ответ.
