    ...
    public static String consultationShortWiki() {
        return """
                *Отправьте свой вопрос*
                ...
                _*Постарайтесь выразить свой вопрос ясно и в полном объеме. Можете использовать несколько предложений. Это поможет боту лучше понять ваш запрос и дать более точный ответ._
                """;
    }
