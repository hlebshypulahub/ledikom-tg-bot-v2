...
public enum GymnasticsMenuItem {
    ...
    public static final String GYMNASTICS_BUTTON_CALLBACK_STRING = "gymnastics_";

    public final String buttonText;
    public final String callbackDataString;
    public final String videoLink;

    GymnasticsMenuItem(String buttonText, String callbackDataString, final String videoLink) {
